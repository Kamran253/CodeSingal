...
const Card = ({ icon, title, buttonText }) => {
  return (
   <div className="cards-containe">
      <div className="car">
        <div className="ico"><img src={ImageText} className='ico-img'/></div> {/* Use your icon here */}
        <h3>Ready to optimize your <br /> tech recruiting process?</h3>
        <button>REQUEST A CALL</button>
      </div>

      <div className="car"> 
        <div className="ico"><img src={ImageMess} className='ico-img' /></div> {/* Use your icon here */}
